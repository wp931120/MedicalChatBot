# coding=utf-8
# Implements API for baichuan13B in OpenAI's format. (https://platform.openai.com/docs/api-reference/chat)
...
if __name__ == "__main__":
    ...
    model.generation_config = GenerationConfig.from_pretrained("/data_hdd/hfmodel/Baichuan-13B-Chat", trust_remote_code=True) # 可指定不同的生成长度、top_p等相关超参
